...
ud = Base64(Join('\n', [
     ...
     "sudo aws s3 cp s3://esausi-backups/jenkins/jenkins-bkp-latest.tar.gz /tmp/bkps/",
     "sudo aws s3 cp s3://esausi-backups/jenkins/jenkins-aws-createbkp.sh /tmp/bkps/",
     "sudo chmod 555 /tmp/bkps/jenkins-aws-createbkp.sh",
     "cd /tmp/bkps/",
